...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
          ...
          <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full transform hover:scale-105 transition-transform duration-300">
            <div className="flex flex-col grow pt-3 w-full text-center capitalize shadow-lg bg-neutral-100 leading-[100%] max-md:mt-8">
              ...
              <div className="flex flex-col px-14 py-7 mt-3.5 w-full bg-white max-md:px-5">
                ...
                <div className="flex gap-2.5 self-center mt-5">
                  <div className="grow text-xs text-stone-300">449.99 SAR</div>
                  <div className="text-lg font-semibold text-stone-950 text-opacity-50">
                    312.49 SAR
                  </div>
      ...
      <div className="px-5 mt-8 w-full max-w-[1422px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full transform hover:scale-105 transition-transform duration-300">
            <div className="flex flex-col grow pt-3 w-full text-center capitalize shadow-lg bg-neutral-100 leading-[100%] max-md:mt-8">
              <Image
          ...
          <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full transform hover:scale-105 transition-transform duration-300">
            <div className="flex flex-col grow pt-3 w-full text-center capitalize shadow-lg bg-neutral-100 leading-[100%] max-md:mt-8">
              ...
              <div className="flex flex-col px-20 py-7 mt-3.5 w-full bg-white max-md:px-5">
                <div className="text-2xl font-semibold text-stone-950 max-md:mx-1">
                  Sardinia White
                </div>
                <div className="flex gap-3 mt-7 max-md:mx-1">
                  <div className="grow text-xs text-stone-300">449.99 SAR</div>
                  <div className="text-lg font-semibold text-stone-950 text-opacity-50">
                    312.49 SAR
                  </div>
